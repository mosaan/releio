...
const UserActionBar: FC = () => {
  return (
    <ActionBarPrimitive.Root
      ...
      className="text-muted-foreground flex gap-1 col-start-3 row-start-2 -mr-1 data-[floating]:bg-background data-[floating]:absolute data-[floating]:rounded-md data-[floating]:border data-[floating]:p-1 data-[floating]:shadow-sm"
    >
